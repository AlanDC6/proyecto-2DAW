...
<div class="navbar navbar-expand navbar-dark bg-dark">
    <div class="container">
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('comprar') }}">Deporte</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('comprar') }}">Marcas</a>
            </li>
  ...
  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{asset('img/pagina_principal/banner/BannerBañadores.jpg')}}" class="d-block w-100" alt="...">
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                ...
                <p class="text-center"><a href="{{ route('comprarRopa') }}" class="btn btn-success">Comprar</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                ...
                <p class="text-center"><a href="{{ route('comprarCalzado') }}" class="btn btn-success">Comprar</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <img src="{{asset('img/pagina_principal/img_prods/complementos.jpg')}}" class="rounded-circle img-fluid">
                <h2 class="h5 text-center mt-3 mb-3">Complementos</h2>
                <p class="text-center"><a href="{{ route('comprarComplementos') }}" class="btn btn-success">Comprar</a></p>
            </div>
        </div>
    </section>
</div>
