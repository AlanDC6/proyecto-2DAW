...
<div id="opciones">
    <a href="<?php echo e(route('menuNuevo')); ?>" class="btn btn-success">Añadir  <i class="fa-solid fa-plus"></i></a>
</div>
  ...
  <tbody>
    <?php $__currentLoopData = $datosProductos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td id="imagen-td"><img class="card-img-top imagen" src="<?php echo e(asset($producto->imagen)); ?>" alt="..."/></td>
