  ...
  <tbody>
    <?php $__currentLoopData = $datosProductos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td>
                <a href="#" class="btn btn-primary">Editar  <i class="fa-solid fa-pen-to-square"></i></a>
                <a  href="#" class="btn btn-danger">Borrar  <i class="fa-solid fa-trash"></i></a>
            </td>
        </tr>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\usuario\OneDrive\Escritorio\git\proyecto-2DAW\laravel\tienda_ropa\resources\views/administrar.blade.php ENDPATH**/ ?>