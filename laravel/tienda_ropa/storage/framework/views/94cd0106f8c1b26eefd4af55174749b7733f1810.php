...
unset($__errorArgs, $__bag); ?>
              ...
              <hr class="my-4">
              <a href="<?php echo e(route('register')); ?>">¿Todavia no tienes cuenta? Registrarse</a><br>
              <a href="<?php echo e(route('password.request')); ?>">¿Has olvidado la contraseña?</a>
            </form>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\usuario\OneDrive\Escritorio\git\proyecto-2DAW\laravel\tienda_ropa\resources\views/auth/login.blade.php ENDPATH**/ ?>